...
<div class="form-group">
    ...
    <input type="date" id="availabilityDate" name="availabilityDate" class="box" required>
</div>

<div class="form-group">
    <label for="availabilityTime">Available Time:</label>
    <input type="time" id="availabilityTime" name="availabilityTime" class="box" required>
</div>
                </div>
